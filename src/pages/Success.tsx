            ...
            <div className="status-page__digital">
              ...
              {order.items
                ...
                .map((item: any, i: number) => {
                  ...
                  const downloadUrl = item.downloadFileId
                    ? `${import.meta.env.VITE_CONVEX_SITE_URL}/download?orderId=${order._id}&email=${encodeURIComponent(order.email)}&itemIndex=${itemIndex}`
                    : null;
                  return (
                    <div key={i} className="status-page__digital-item">
                      ...
                      {downloadUrl && (
                        <p>
                          <a href={downloadUrl} target="_blank" rel="noopener noreferrer" className="status-page__download-link">
                            Download
                          </a>
                        </p>
                      )}
